...
import { HistoryItem, SafariTab } from "./types";
...
export const getTitle = (tab: SafariTab) => tab.title;
//_.truncate(tab.title, { length: 75 });
...
export const search = (collection: object[], keys: string[], searchText: string) => collection;
/*
